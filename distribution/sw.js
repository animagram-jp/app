...
const PRECACHE = [
    ...
    "./css/reset.css?v={version}",
    "./css/base.css?v={version}",
    "./css/data_style.css?v={version}",
    "./css/data_size.css?v={version}",
    "./css/data_sign.css?v={version}",
    "./css/data_group.css?v={version}",
    "./css/button.css?v={version}",
    "./css-app/config.css?v={version}",
    "./css-app/style.css?v={version}",
