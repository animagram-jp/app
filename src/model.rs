...
impl Skill {
    ...
    pub fn id(&self) -> u32 {
        ...
        match self {
            Self::Accounting       => base +  0,
            Self::Anthropology     => base +  1,
            Self::Appraise         => base +  2,
            Self::Archaeology      => base +  3,
            Self::ArtAndCraft      => base +  4,
            Self::Charm            => base +  5,
            Self::Climb            => base +  6,
            Self::ComputerUse      => base +  7,
            Self::CreditRating     => base +  8,
            Self::CthulhuMythos    => base +  9,
            Self::Disguise         => base + 10,
            Self::Dodge            => base + 11,
            Self::DriveAuto        => base + 12,
            Self::ElectricalRepair => base + 13,
            Self::Electronics      => base + 14,
            Self::FastTalk         => base + 15,
            Self::Fighting         => base + 16,
            Self::Firearms         => base + 17,
            Self::FirstAid         => base + 18,
            Self::History          => base + 19,
            Self::Intimidate       => base + 20,
            Self::Jump             => base + 21,
            Self::LanguageOther    => base + 22,
            Self::LanguageOwn      => base + 23,
            Self::Law              => base + 24,
            Self::LibraryUse       => base + 25,
            Self::Listen           => base + 26,
            Self::Locksmith        => base + 27,
            Self::MechanicalRepair => base + 28,
            Self::Medicine         => base + 29,
            Self::NaturalWorld     => base + 30,
            Self::Navigate         => base + 31,
            Self::Occult           => base + 32,
            Self::Persuade         => base + 33,
            Self::Pilot            => base + 34,
            Self::Psychoanalysis   => base + 35,
            Self::Psychology       => base + 36,
            Self::Ride             => base + 37,
            Self::Science          => base + 38,
            Self::SleightOfHand    => base + 39,
            Self::SpotHidden       => base + 40,
            Self::Stealth          => base + 41,
            Self::Survival         => base + 42,
            Self::Swim             => base + 43,
            Self::Throw            => base + 44,
            Self::Track            => base + 45,
            Self::Custom           => base + 46,
