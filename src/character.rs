...
impl Skill {
    pub fn list() -> Vec<Skill> {
        vec![
            ...
            Self::Intimidate,
            Self::Jump,
            Self::LanguageOther(LanguageSpec::Custom(String::new())),
            Self::LanguageOwn,
            Self::Law,
            Self::LibraryUse,
            Self::Listen,
            ...
            Self::Occult,
            Self::Persuade,
            Self::Pilot(PilotSpec::Boat),
            Self::Psychoanalysis,
            Self::Psychology,
            Self::Ride,
            Self::Science(ScienceSpec::Biology),
            Self::SleightOfHand,
            Self::SpotHidden,
            Self::Stealth,
            Self::Survival(SurvivalSpec::Sea),
            Self::Swim,
            Self::Throw,
            Self::Track,
            Self::Custom { name: String::new(), spec: None },
        ]
    }
